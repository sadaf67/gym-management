        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoachesCount = table.Column<int>(type: "int", nullable: true),
                    ClassesCount = table.Column<int>(type: "int", nullable: true),
                    YearsCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "SiteSettings",
                columns: new[] { "Id", "AboutImage", "AboutText", "AboutTitle", "Address", "ClassesCount", "CoachesCount", "CreatedAt", "Email", "Favicon", "FooterText", "HeroImage", "HeroSubTitle", "HeroTitle", "HeroVideoUrl", "Instagram", "IsDeleted", "Logo", "MapEmbed", "MembersCount", "Phone", "Phone2", "PrimaryColor", "SiteDescription", "SiteKeywords", "SiteName", "Telegram", "UpdatedAt", "WhatsApp", "WorkingHours", "YearsCount" },
                values: new object[] { 1, null, "باشگاه تهیلا با بهترین امکانات و مربیان مجرب آماده خدمت‌رسانی به شماست.", "درباره ما", "تهران، ...", 15, 10, new DateTime(2026, 6, 7, 14, 24, 6, 245, DateTimeKind.Local).AddTicks(5049), null, null, "تمامی حقوق متعلق به باشگاه تهیلا می‌باشد.", null, "قوی‌تر، سالم‌تر، بهتر", "به باشگاه تهیلا خوش آمدید", null, null, false, null, null, 500, "021-00000000", null, "#FF2D78", null, null, "تهیلا", null, null, null, "شنبه تا پنج‌شنبه: ۷ الی ۲۳", 5 });
